...
# WRF file
datapathwrf      = 'D:'
wrfoldfilename   = '%s/geo_em.d01.nc'%datapathwrf
...
datapathimage    = 'D:/MSc thesis Gijs Koetsenruijter/geogrid'
...
lu_index_img     = imagefile.variables['GLCT'][6,:,:]
dlat_img         = 1./12.
dlon_img         = 1./12.
imagefile.close()
...
wrfnewfilename = '%s/geo_em.d01.new2000.nc'%datapathwrf
