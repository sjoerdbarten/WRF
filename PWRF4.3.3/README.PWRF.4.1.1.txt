...
The files are supplements to WRF-ARW version 3.9.1 available from NCAR at http://www.mmm.ucar.edu/wrf/users/download/. 
...
Potential issue: If you run with the fix for sea ice fraction updating during a run, you may need to run with a slightly smaller timestep (75-80%) because of issues between sea surface temperature, skin temperature, and sea ice consistency.
...
mv run/VEGPARM.TBL run/VEGPARM.TBL-unpolar  	{store the previous versions
