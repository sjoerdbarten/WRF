...
def loaddata(o3datafile,wrfdatafile,dailyaverage,histplot,statistics):
	...
	cf1 = nc.Dataset('/lustre/backup/WUR/ESG/barte035/wrfout_chem_nudgedBL_coareg_sherweniodide_d01_2008-08-10_00:00:00','r') #this is an exact copy of df1 and df2, but never used in plotting. Just here to keep the script working because the coaregv2 run has been removed from lustre..
	cf2 = nc.Dataset('/lustre/backup/WUR/ESG/barte035/wrfout_chem_nudgedBL_coareg_sherweniodide_d01_2008-08-11_01:00:00','r')
	df1 = nc.Dataset('/lustre/backup/WUR/ESG/barte035/wrfout_chem_nudgedBL_coareg_sherweniodide_d01_2008-08-10_00:00:00','r')
	df2 = nc.Dataset('/lustre/backup/WUR/ESG/barte035/wrfout_chem_nudgedBL_coareg_sherweniodide_d01_2008-08-11_01:00:00','r')
	...
	#wrfdata_era5_coareg = nc.Dataset('/lustre/backup/WUR/ESG/barte035/wrfout_era5_coaregnudged_d01_2008-08-10_00:00:00','r') #era5this
	...
	wrfo3data_run5 = np.concatenate((df1['o3'][0:25,0,:,:]*1000.,df2['o3'][:,0,:,:]*1000.),axis=0) #era5this
	#wrfo3data_run5 = wrfdata_era5_coareg['o3'][:,0,:,:]*1000. #surface ozone to ppb #era5this
	...
	stationdatacamsnew = stationdata[::3]
	...
	camsnewdata = np.load('/home/WUR/barte035/WRFChem/o3_analysis_DATA/CAMS-MACC/MACCnpo3arraynew.npy')
	camsnewtime = np.load('/home/WUR/barte035/WRFChem/o3_analysis_DATA/CAMS-MACC/MACCnptimearraynew.npy')
	...
	#camsnew data
	camsnew_barrow = camsnewdata[:,loc_barrow[0],loc_barrow[1]]
	camsnew_storhofdi = camsnewdata[:,loc_storhofdi[0],loc_storhofdi[1]]
	camsnew_summit = camsnewdata[:,loc_summit[0],loc_summit[1]]
	camsnew_ahtari = camsnewdata[:,loc_ahtari[0],loc_ahtari[1]]
	camsnew_bredkalen = camsnewdata[:,loc_bredkalen[0],loc_bredkalen[1]]
	camsnew_esrange = camsnewdata[:,loc_esrange[0],loc_esrange[1]]
	camsnew_karasjok = camsnewdata[:,loc_karasjok[0],loc_karasjok[1]]
	camsnew_karvatn = camsnewdata[:,loc_karvatn[0],loc_karvatn[1]]
	camsnew_lerwick = camsnewdata[:,loc_lerwick[0],loc_lerwick[1]]
	camsnew_oulanka = camsnewdata[:,loc_oulanka[0],loc_oulanka[1]]
	camsnew_pallas = camsnewdata[:,loc_pallas[0],loc_pallas[1]]
	camsnew_tustervatn = camsnewdata[:,loc_tustervatn[0],loc_tustervatn[1]]
	camsnew_villum = camsnewdata[:,loc_villum[0],loc_villum[1]]
	camsnew_vindeln = camsnewdata[:,loc_vindeln[0],loc_vindeln[1]]
	camsnew_virolahti = camsnewdata[:,loc_virolahti[0],loc_virolahti[1]]
	camsnew_zeppelin = camsnewdata[:,loc_zeppelin[0],loc_zeppelin[1]]
	camsnew_ascos = camsnewdata[:,loc_ascos[0],loc_ascos[1]]
	camsnew_whitehorse = camsnewdata[:,loc_whitehorse[0],loc_whitehorse[1]]
	camsnew_yellowknife = camsnewdata[:,loc_yellowknife[0],loc_yellowknife[1]]
	camsnew_normanwells = camsnewdata[:,loc_normanwells[0],loc_normanwells[1]]
	camsnew_fortliard = camsnewdata[:,loc_fortliard[0],loc_fortliard[1]]
	camsnew_inuvik = camsnewdata[:,loc_inuvik[0],loc_inuvik[1]]
	camsnew_denalinp = camsnewdata[:,loc_denalinp[0],loc_denalinp[1]]
	camsnew_alert = camsnewdata[:,loc_alert[0],loc_alert[1]]
	camsnew_hurdal = camsnewdata[:,loc_hurdal[0],loc_hurdal[1]]
	...
	camsnewlist = [camsnew_barrow,camsnew_storhofdi,camsnew_summit,camsnew_ahtari,camsnew_bredkalen,camsnew_esrange,camsnew_karasjok,camsnew_karvatn,camsnew_lerwick,camsnew_oulanka,camsnew_pallas,camsnew_tustervatn,camsnew_villum,camsnew_vindeln,camsnew_virolahti,camsnew_zeppelin,camsnew_ascos,camsnew_whitehorse,camsnew_yellowknife,camsnew_normanwells,camsnew_fortliard,camsnew_inuvik,camsnew_denalinp,camsnew_alert,camsnew_hurdal]
	filters = 	["HA", "zRE","HA", "zzDI","zzDI","zRE","zRE" ,"zzDI","zRE","zzDI","zRE" ,"zzDI","HA" ,"zzDI","zzDI","HA" ,"HA" ,"zzDI","zRE" ,"zzDI","zzDI","zRE","zRE" ,"HA" ,"zzDI"]
	...
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/DEFAULT.npy',plotlist_base)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/NUDGED.npy',plotlist_run3)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/COAREG.npy',plotlist_run5) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/CAMS.npy',camslist)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/CAMSnew.npy',camsnewlist)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/filters.npy',filters)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/loclist_abb.npy',loclist_abb)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/loclist.npy',loclist)
	stationdata.to_pickle('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/stationdata.pkl')
	stationdatacams.to_pickle('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/stationdatacams.pkl')
	stationdatacamsnew.to_pickle('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/stationdatacamsnew.pkl')
	
	
	#Save HA for timeseries in notebooks
	print(wrf_barrow_base.shape,wrf_barrow_run3.shape,wrf_barrow_run5.shape)
	barrow_fornotebook = [wrf_barrow_base,wrf_barrow_run3,wrf_barrow_run5]
	summit_fornotebook = [wrf_summit_base,wrf_summit_run3,wrf_summit_run5]
	villum_fornotebook = [wrf_villum_base,wrf_villum_run3,wrf_villum_run5]
	zeppelin_fornotebook = [wrf_zeppelin_base,wrf_zeppelin_run3,wrf_zeppelin_run5]
	ascos_fornotebook = [wrf_ascos_base,wrf_ascos_run3,wrf_ascos_run5]
	alert_fornotebook = [wrf_alert_base,wrf_alert_run3,wrf_alert_run5]
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/barrow_fornotebook.npy',barrow_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/barrow_cams_fornotebook.npy',cams_barrow)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/barrow_camsnew_fornotebook.npy',camsnew_barrow)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/summit_fornotebook.npy',summit_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/summit_cams_fornotebook.npy',cams_summit)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/summit_camsnew_fornotebook.npy',camsnew_summit)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/villum_fornotebook.npy',villum_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/villum_cams_fornotebook.npy',cams_villum)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/villum_camsnew_fornotebook.npy',camsnew_villum)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/zeppelin_fornotebook.npy',zeppelin_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/zeppelin_cams_fornotebook.npy',cams_zeppelin)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/zeppelin_camsnew_fornotebook.npy',camsnew_zeppelin)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/ascos_fornotebook.npy',ascos_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/ascos_cams_fornotebook.npy',cams_ascos)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/ascos_camsnew_fornotebook.npy',camsnew_ascos)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/alert_fornotebook.npy',alert_fornotebook) #era5this
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/alert_cams_fornotebook.npy',cams_alert)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/alert_camsnew_fornotebook.npy',camsnew_alert)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/timearr.npy',timearr)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/timearrcams.npy',camstime)
	np.save('/home/WUR/barte035/WRFChem/Python/Arrays/Surfaceo3/timearrcamsnew.npy',camsnewtime)
	...
	bias_camsnew = np.zeros(len(loclist))
	mae_camsnew = np.zeros(len(loclist))
	#rmse_camsnew = np.zeros(len(loclist))
	...
	for i in range(len(loclist)):
		...
		mecamsnew = mean_error(camsnewlist[i],stationdatacamsnew[loclist[i]+'_o3'])
		maecamsnew = mean_abs_error(camsnewlist[i],stationdatacamsnew[loclist[i]+'_o3'])
		#rmsecams = root_mean_squared_error(camslist[i][filterr][~np.isnan(camslist[i][filterr])],stationdatacams[loclist[i]+'_o3'].values[filterr][~np.isnan(camslist[i][filterr])])
		...
		bias_camsnew[i] = mecamsnew
		mae_camsnew[i] = maecamsnew
		#rmse_cams[i] = rmsecamsnew

		plt.figure(figsize=(15,8))
		plt.plot(timearr,stationdata[loclist[i]+'_o3'],'ko',label='Observartions')
		plt.plot(timearr,plotlist_base[i],'r-',label='DEFAULT')
		...
		#plt.plot(timearr,plotlist_run4[i],'m-',label='Run 4')
		plt.plot(timearr,plotlist_run5[i],color='green',linestyle='-',label='COAREG')
		plt.plot(camstime,camslist[i],marker='x',linewidth=0,color='blue',markersize=8,label='CAMS')
		plt.plot(camsnewtime,camsnewlist[i],marker='x',linewidth=0,color='magenta',markersize=8,label='CAMS')
		plt.ylim([0,60])
		...
		plt.text(timearr[6],51,"Bias/MAE CAMS         = "+str(round(mecams,2))+"/"+str(round(maecams,2))+" ppb")
		plt.text(timearr[6],51,"Bias/MAE CAMSnew         = "+str(round(mecamsnew,2))+"/"+str(round(maecamsnew,2))+" ppb")
		...
		plt.savefig('Figures/Surfaceplots/Timeseries/'+loclist[i]+'_final_inclcamsnew',dpi=300)
		#plt.show()
		plt.close()
		...
		if statistics == True:
			...
			data = [(plotlist_base[i]-stationdata[loclist[i]+'_o3'])[filterr],(plotlist_run3[i]-stationdata[loclist[i]+'_o3'])[filterr],(plotlist_run5[i]-stationdata[loclist[i]+'_o3'])[filterr],(camslist[i]-stationdatacams[loclist[i]+'_o3'])[filterr],(camsnewlist[i]-stationdatacamsnew[loclist[i]+'_o3'])[filterr]]
			...
			ax.set_xticklabels(['DEFAULT','NUDGED','COAREG','CAMS','CAMSNEW'],fontsize=13)
			plt.savefig('Figures/Surfaceplots/Boxplot/'+loclist[i]+'_boxplot_final_inclcamsnew',dpi=300)
			#plt.show()
			plt.close()
			...
			if i == len(loclist)-1:
				...
				df = pd.DataFrame(data=[bias_base,bias_nofixdep_nudged,bias_coareg_nudged,bias_cams,bias_camsnew,
							     mae_base,mae_nofixdep_nudged,mae_coareg_nudged,mae_cams,mae_camsnew],
					          index=['bias_DEFAULT','bias_NUDGED','bias_COAREG','bias_CAMS','bias_CAMSnew',
							      'mae_DEFAULT','mae_NUDGED','mae_COAREG','mae_CAMS','mae_CAMSnew'],
						  columns=loclist_abb).T
				df['loctype'] = filters
				loctypes = ['HA','zRE','zzDI']
				markertypes = ['o','^','s']
				#colortypes = ['red','green','blue','orange','magenta','cyan','black']
				colortypes = ['red','orange','green','blue','magenta']
				plooptext = ['bias','mae']
				...
				for p in [0,1]:
					...
					runstext = [plooptext[p]+'_DEFAULT',plooptext[p]+'_NUDGED',plooptext[p]+'_COAREG',plooptext[p]+'_CAMS',plooptext[p]+'_CAMSnew']
					counter=1.
					...
					if plooptext[p] == 'mae':
						custom_lines = [Line2D([0], [0], color='red', lw=0, marker='o', markersize=6),
                						...
                						Line2D([0], [0], color='green', lw=0, marker='o', markersize=6),
								Line2D([0], [0], color='blue', lw=0, marker='o', markersize=6),
								Line2D([0], [0], color='magenta', lw=0, marker='o', markersize=6)]
						ax.legend(custom_lines, ['BASE', 'NUDGED', 'COAREG', 'CAMS','CAMSnew'],loc=1)
					plt.savefig('Figures/Surfaceplots/Boxplot/'+plooptext[p]+'_AllstationsCAMS_inclcamsnew',dpi=300)
					plt.show()
		...
		if histplot == True:
			...
			ax.hist(plotlist_base[i],bins=60,range=(0.,60.),normed=True,cumulative=False,histtype='step',alpha=1,color='red',label='DEFAULT')
			...
			#ax.hist(plotlist_run4[i].ravel(),bins=60,range=(0.,60.),normed=True,cumulative=False,histtype='step',alpha=1,color='magenta',label='Run 4')
			ax.hist(plotlist_run5[i].ravel(),bins=60,range=(0.,60.),normed=True,cumulative=False,histtype='step',alpha=1,color='green',label='COAREG')
			ax.hist(camslist[i].ravel(),bins=60,range=(0.,60.),normed=True,cumulative=False,histtype='step',alpha=1,color='blue',label='CAMS')
			...
			plt.title(loclist[i])
			plt.savefig('Figures/Surfaceplots/Histogram/HIST_inclnudged_cams'+loclist[i],dpi=150)
			#plt.show()
			plt.close()				
		...
		if dailyaverage == True:
			...
			plt.plot(timearr_day,base_daily,'r-',label='DEFAULT')
			...
			#plt.plot(timearr_day,base_run4,'m-',label='Run 4')
			plt.plot(timearr_day,base_run5,color='green',linestyle='-',label='COAREG')
			plt.plot(timearr_day,camsdailyavg,'b-',label='CAMS')
			plt.ylim([0,60])
			plt.title(loclist[i])
			plt.legend(loc=1)
			plt.savefig('Figures/Surfaceplots/DailyAvg/'+loclist[i]+'_DAILY_inclnudged_cams',dpi=300)
			plt.close()
