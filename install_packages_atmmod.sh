...
python -m pip install --no-cache-dir --user numexpr==2.7.3  2>/dev/null
python -m pip install --no-cache-dir --user numpy==1.20.3  2>/dev/null
...
python -m pip install --no-cache-dir --user pandas==2.0.3  2>/dev/null
python -m pip install --no-cache-dir --user shapely==1.8.5 --no-binary shapely --ignore-installed  2>/dev/null
python -m pip install --no-cache-dir --user numpy==1.23.1  2>/dev/null
