...
MACCpath         = '../EmissionData' #%homedir                   # location where the MACC Emission data files are located
geo_em_path      = '../WPS'       #%homedir                      # location where the geo_em.dNN.nc files are located
wrfchemipath     = '../WRF/run'                                    # location where the wrfchemifiles will be written to
