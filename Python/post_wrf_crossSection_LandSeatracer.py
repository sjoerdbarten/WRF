...
# Select the height dimensions of the vertical profiles
bot_height = 0. # lowest height
top_height = 5000. # highest height
step_size = 10. # step of height used
...
with PdfPages('plt_crossSection_LandSeatracer.pdf') as pdf:
   ...
   var = wrf.getvar(infile,'LAND_tracer',timeidx=0)
   ...
   for tracer in ['LAND_tracer','SEA_tracer']: 
