...
tracers_extra    = ['LAND_tracer','SEA_tracer','tracer_stack_k01','tracer_stack_k05','tracer_stack_k15','tracer_stack_k20','VOC','tracer_18','tracer_19']
Nsnaps           = 13 

outunits         = {'PM25': 'kg/km2/hr', 'CO':'mole/km2/hr', 'PM10':'kg/km2/hr','CH4':'mole/km2/hr','SO2':'mole/km2/hr','NMVOC':'kg/km2/hr','NH3':'mole/km2/hr','NOx':'mole/km2/hr','BC':'kg/km2/hr','NO2':'mole/km2/hr','NO':'mole/km2/hr','PM25traffic':'mole/km2/hr','PMMP':'mole/km2/hr'}
outunits_extra   = {'LAND_tracer':'mole/km2/hr','SEA_tracer':'mole/km2/hr','tracer_stack_k01':'mole/km2/hr','tracer_stack_k05':'mole/km2/hr','tracer_stack_k15':'mole/km2/hr','tracer_stack_k20':'mole/km2/hr','VOC':'mole/km2/hr','tracer_18':'mole/km2/hr','tracer_19':'mole/km2/hr'}
...
PM25TOPM25traffic     = np.asarray([[0.000, 0.000, 0.000, 0.000],  #  1 This is the same as above, but all non-traffic emissions are set to zero
                                    [0.000, 0.000, 0.000, 0.000],  #  2
#                                   [0.000, 0.000, 0.000, 0.000],  #  3
#                                   [0.000, 0.000, 0.000, 0.000],  #  4
                                    [0.000, 0.000, 0.000, 0.000],  # 34
...
PM25TOMP               = PM25TOPM25traffic * 0.10                  #    Microplastics emissions are 10% of the PM25TOPM25traffic emissions 
...
if not 'MACCloaded' in progress:
    ...
    E_macc['PM25traffic']      = E_macc['PM25'][:] * 0
    E_macc['PMMP']             = E_macc['PM25'][:] * 0
    for isnap in range(Nsnaps):
        E_macc['BC'         ][isnap] = E_macc['PM25'][isnap] * (PM25TOBC         [isnap,0] + PM25TOBC         [isnap,2])
        E_macc['PM25traffic'][isnap] = E_macc['PM25'][isnap] * (PM25TOPM25traffic[isnap,0] + PM25TOPM25traffic[isnap,2])
        E_macc['PMMP'       ][isnap] = E_macc['PM25'][isnap] * (PM25TOMP         [isnap,0] + PM25TOMP         [isnap,2])
        tracers.extend(['PM25traffic','PMMP'])
    ...
    for domain,hour in product(domains,rrule(freq=HOURLY,dtstart=sdate,until=edate)):
        ...
        for tracer in tracers_extra:
            ...
            if tracer ==  'LAND_tracer':
                ...
                ncE_tracer[0,0,:,:] = 0.
            elif  tracer == 'tracer_18':
                ncE_tracer[0,0,:,:] = (TP[0,Isnap,:,:] * E_wrf[domain,'PM25traffic'][Isnap,:,:]).sum(axis=0)
            elif  tracer == 'tracer_19':
                ncE_tracer[0,0,:,:] = (TP[0,Isnap,:,:] * E_wrf[domain,'PMMP'       ][Isnap,:,:]).sum(axis=0)
            else: 
                print('wrong tracer')
